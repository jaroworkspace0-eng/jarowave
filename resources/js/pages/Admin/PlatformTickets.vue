...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    // { title: 'Platform Tickets', href: '/platform-tickets' },
];
...
const base = `${import.meta.env.VITE_APP_URL}/api/admin/platform-tickets`;
        ...
        <div class="page-root">
            ...
            <div class="page-header">
                <div class="page-header__left">
                    ...
                    <h1 class="page-header__title">Platform Tickets</h1>
                    <p class="page-header__sub">Echo Link support requests</p>
                </div>
                        ...
                        <template v-else-if="selected">
                            ...
                            <div class="modal-sheet__body">
                                ...
                                <div class="review-info-panel">
                                    <div class="field__label">Requester</div>
