...
const form = ref({ name: '', email: '', phone: '+27', channel_id: '' as any });
    ...
    <AppLayout>
        <div class="page-root">
            ...
            <div class="table-card">
                ...
                <div v-else-if="guards.length === 0" class="empty-state">
                    <p class="empty-state__title">No guards yet</p>
            ...
            >
                <div class="modal-sheet" style="max-width: 480px">
                    <div class="modal-sheet__header">
                        <div class="modal-sheet__title">Add Guard</div>
